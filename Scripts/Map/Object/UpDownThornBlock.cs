...
public class UpDownThornBlock : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (Move)
        {
            if (MoveA)
            {
                ...
                if (Vector3.Distance(trapA.transform.localPosition, orgPos) >= 0.7f)
                {
            ...
            else if (!MoveA)
            {
                ...
                if (Vector3.Distance(trapA.transform.localPosition, orgPos) <= 0.02f)
                {
